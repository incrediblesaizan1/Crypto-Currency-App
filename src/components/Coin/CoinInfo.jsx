...
const CoinInfo = ({ heading, description }) => {
  ...
  return (
    <div className="block w-[95vw] rounded-3xl bx my-5 mx-auto break-words py-4 px-6 text-justify tracking-tight">
      ...
      {description.length > 200 ? (
        <p
          ...
          dangerouslySetInnerHTML={{
            __html: isExpanded ? shortDesc : longDesc,
          }}
        ></p>
      ) : (
        <p
      ...
      {description.length == 0 && <p>There is no description available</p>}
    </div>
  );
};
