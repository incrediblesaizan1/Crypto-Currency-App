...
const Grid = ({ coin, i }) => {
  return (
    <NavLink to={`/coin/${coin.id}`} ><div className={` bx ${coin.price_change_percentage_24h > 0 ?"hover:border-2 hover:border-solid hover:border-[var(--green)]":"hover:border-2 hover:border-solid hover:border-[var(--red)]"} w-[342px]  h-[320px]  border-2 border-solid border-[var(--darkgrey)] rounded-xl`} >
