...
const List = ({coin, i}) => {
  ...
  return (
    ...
    initial={{ opacity: 0, x: -50 }}
     ...
     className=' ml-[-0.94rem] md:ml-[1.3rem] m-2 px-4  w-[95vw] h-12 md:h-20 bx lg:h-28 xl:h-32 hover:bg-[var(--darkgrey)] rounded-2xl  sm:rounded-3xl flex items-center justify-start xl:gap-28 '
      >
